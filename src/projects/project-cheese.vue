<template>
    <section>
        ...
        <article>
        <figure>
        <img class="middle-image" v-lazy="'http://res.cloudinary.com/yiou-me/image/upload/c_scale,w_1000/v1486434801/game/SwissCONCEPT.png'"/>
        <figcaption class="middle-image">Designed by my teammate Simon Ouyang</figcaption>
        </figure>
