<template>
    <section>
        <github-ribbon link="https://github.com/yiochen/Floral"></github-ribbon>
        <project-title date="11/2015" languages="JavaScript">Floral</project-title>
        <article>
            <p><code>Floral</code> is a small artistic expression using <a href="http://paperjs.org/">Paper.js</a>. I tried to dynamically generate some kind of floral patterns, such as the one below.</p>
            <cloud-image name="front-end/floral-example"></cloud-image>
            <p>The drawing part is easy, <a href="http://paperjs.org/">Paper.js</a> makes it very simple to manipulate HTML Canvas. My plan was the following:</p>
            <ol>
